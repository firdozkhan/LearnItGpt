  ...
  return (
    <div className="w-full h-screen overflow-hidden overflow-y-auto bg-[#1c1c1d] ">
      <div className="w-full relative">
        <a href="http://localhost:3001" className="text-white text-3xl absolute left-20 top-10"><IoMdArrowRoundBack /></a>
      ...
      <div className="w-full h-full flex justify-evenly items-center">
        {/* English */}
        <NavLink to="/english" className="w-[23%] h-[65%] rounded-lg overflow-hidden bg-[#373a3f]">
          <img
        ...
        {/* History */}
        <NavLink to="/history" className="w-[23%] h-[65%] rounded-lg overflow-hidden bg-[#373a3f]">
          <img
        ...
        {/* {Science} */}
        <NavLink to="/science" className="w-[23%] h-[65%] rounded-lg overflow-hidden bg-[#373a3f]">
          <img
        ...
        {/* {Maths} */}
        <NavLink to="/maths" className="w-[23%] h-[65%] rounded-lg overflow-hidden bg-[#373a3f]">
          <img
