...
const Science = () => {
  ...
  const [messages, setMessage] = useState([
    {
      text: "Hello, I am your science  teacher here to answer your all doubts realated to science 24/7. I am trained by Firdoz, Tejas, Suyog and Atharva",
      isBot: true,
    },
  ]);
    ...
    <div className="w-full h-screen bg-[#242630] flex">
      ...
      <div className="w-[22%] h-full border-r border-r-zinc-400 flex flex-col items-center justify-between">
        <div className="flex flex-col items-center gap-10 mt-4">
          <h1 className="text-5xl font-semibold text-zinc-300">Science</h1>
          <div className="w-[85%] bg-[#16191F] rounded-lg p-2">
            <h3 className="text-zinc-400 font-bold text-2xl">CV Raman</h3>
            <p className="text-zinc-500 font-semibold text-sm">
              Hello, my dear students I am your science teacher. I will teach you
              each and every concept of science in details and I am sure that
